...
const navigationtwo = [
    ...
    { name: 'SIGNUP', href: 'https://tracker.traffury.in/account/signup', current: false },
                  ...
                  <div className="flex space-x-4">
                    {navigationtwo.map((item) => (
                      <a
                        ...
                        href={item.href}
                        className={classNames(
                          item.current ? ' text-white' : 'text-red-600 hover:text-red-600 text-lg font-gotham font-bold',
